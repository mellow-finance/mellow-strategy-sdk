"""
    ...
    cd this tests_pytest and python -m unittest UniswapLiquidityAligner_test.py
"""
...
test_check_xy_is_optimal_arr = [
    ...
    ({'x': 0, 'y': 2, 'price': 30}, (True, 0.0, 0.0)),
    ({'x': 0, 'y': 2, 'price': 31}, (True, 0.0, 0.0)),
    ({'x': 0, 'y': 20, 'price': 9}, (False, 0.0, 0.0)),
    ({'x': 0, 'y': 20, 'price': 10}, (False, 0.0, 0.0)),
    ({'x': 0, 'y': 20, 'price': 15}, (False, 0.0, 28.141044025503188)),
    ({'x': 0, 'y': 20, 'price': 30}, (True, 0.0, 0.0)),
    ({'x': 0, 'y': 20, 'price': 31}, (True, 0.0, 0.0)),
    ...
    ({'x': 1, 'y': 0, 'price': 30}, (False, 0.0, 7.482029277778401)),
    ({'x': 1, 'y': 0, 'price': 31}, (False, 0.0, 7.482029277778401)),
    ...
    ({'x': 1, 'y': 2, 'price': 30}, (False, 0.0, 7.482029277778401)),
    ({'x': 1, 'y': 2, 'price': 31}, (False, 0.0, 7.482029277778401)),
    ...
    ({'x': 1, 'y': 20, 'price': 30}, (False, 0.0, 7.482029277778401)),
    ({'x': 1, 'y': 20, 'price': 31}, (False, 0.0, 7.482029277778401)),
    ...
    ({'x': 10, 'y': 0, 'price': 30}, (False, 0.0, 74.820292777784)),
    ({'x': 10, 'y': 0, 'price': 31}, (False, 0.0, 74.820292777784)),
    ...
    ({'x': 10, 'y': 2, 'price': 30}, (False, 0.0, 74.820292777784)),
    ({'x': 10, 'y': 2, 'price': 31}, (False, 0.0, 74.820292777784)),
    ...
    ({'x': 10, 'y': 20, 'price': 30}, (False, 0.0, 74.820292777784)),
    ({'x': 10, 'y': 20, 'price': 31}, (False, 0.0, 74.820292777784)),
